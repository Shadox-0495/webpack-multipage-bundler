...
import { mergeObjects, confDataTables } from "@features/configs.js";

export async function dataTable($htmlTable, url = "", ajaxArgs = {}) {
	...
	let tableTypes = {
		filter: () => {
			...
			conf.ajax.dataSrc = (dataResponse) => {
				if (totalRecords == 0) {
