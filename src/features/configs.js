...
export function confDataTables(args = {}) {
	let conf = {
		order: [[0, "desc"]],
		dom: `<'js-dt-toolbar'
					f
...
export function confSweetAlert(title = "", icon = "info", html = "<div class='js-loading-spinner'><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>", args = {}) {
...
export function confDropZone(args = {}) {
	let obj = {
		url: "api/api.php",
		method: "POST",
		acceptedFiles: "image/*",
